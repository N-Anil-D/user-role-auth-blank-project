            ...
            <div class="modal-body">
                ...
                <div class="modal-wrapper">
                    ...
                    <div class="modal-text">
                        ...
                        <p>Are you sure that you want to delete <u>{{ $selectedUser?->name }}?</u></p>
                    </div>
                </div>
                <div class="modal-footer">
                    <button wire:click="endHisJourney" type="button" class="btn btn-primary">{!! trans('modal.button.confirm') !!}</button>
                    @if ($formButton)
